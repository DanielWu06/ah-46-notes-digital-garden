---
{"dg-publish":true,"permalink":"/lecture-7/lecture-7-egypt-and-nubia/"}
---
...
- Interactions with Egypt
	- More peaceful than previous eras
...
- Purposes of fortresses
	...
	- Dominance/power over locals
	- Measure of security for miners, citizens
- Egypt/Nubia relations
	- Not necessarily that Nubia was threatening
...
- Non-royal text
	...
	- Less focus on large goals, but rather individual events
- Importance
	- Shows us that not all interactions were violent
	- Highlighted the trade interactions between Egypt and Nubia
...
- Purpose
	...
	- Wants to shift from peaceful trade to violence
- Royal text, why is that important?
	- Probably not historical fact
	- Shows why he is self-glazing so much
	- Power/authority
...
- Features
	...
	- Designed to be a defensive site
- Background
	- Buhen Fortress
	- Built by Senwosret I
	- Mudbrick
	- Nubia
...
- Background
	- Uronarti Fortress
	- Built by Senwosret II
	- Mudbrick
	- Nubia
## General Fortress Architecture
- Still places of trade, so not just military
- Administrative buildings
- Granaries
	- Feed the Egyptians
	- Trade with Nubians for gold